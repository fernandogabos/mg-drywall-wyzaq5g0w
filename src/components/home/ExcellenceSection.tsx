      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-primary-foreground/70 text-lg font-light leading-relaxed mb-8">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {features.map((feature, idx) => (
                <li
                  key={idx}
                  className="flex items-center space-x-3 text-sm text-primary-foreground/90"
                >
          ...
          <div className="relative">
            <div className="aspect-square overflow-hidden bg-white/5">
              <img
                src="https://img.usecurling.com/p/800/800?q=construction%20drywall%20details"
