    ...
    <section className="py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-serif text-3xl md:text-5xl text-primary leading-relaxed mb-12">
            "Acreditamos que a verdadeira sofisticação reside na precisão invisível das estruturas
          ...
          <div className="mt-12 h-16 w-[1px] bg-gold mx-auto opacity-50"></div>
        </div>
      </div>
    </section>
  )
